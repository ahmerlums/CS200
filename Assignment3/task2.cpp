		...
		{                                                                             
			...
			{                           //which is greater than the previous number. 
                          ...
                          if(y!=1)                  //1 would be added so end result is y=y-1.Similarly
                               y=y-2;               //again if the number swapped is greater than the previous
                                                    ...
                                                    //it is greater. Then the for loop would proceed
                                                    //by y++ and find other greater numbers and move
                                                    //them back!!.     
	cout << "Sorted array = ";
	for (y=0;y<n;y++)
	cout << array[y] << " " ;
